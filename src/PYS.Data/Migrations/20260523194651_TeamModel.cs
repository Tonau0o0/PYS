...
namespace PYS.Data.Migrations
{
    ...
    public partial class TeamModel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Backfill: existing project owners become 'Owner' members of their projects
            migrationBuilder.Sql(@"
                INSERT INTO ProjectMembers (ProjectId, UserId, Role, JoinedAt, CreatedAt, IsDeleted)
                SELECT p.Id, p.OwnerId, 'Owner', p.CreatedAt, SYSUTCDATETIME(), 0
                FROM Projects p
                WHERE NOT EXISTS (
